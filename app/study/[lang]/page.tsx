...
export default function LanguageHub() {
  ...
  if (isLoading) return <div className="min-h-screen bg-gray-50 flex items-center justify-center font-bold text-gray-500 tracking-widest uppercase">Loading Hub...</div>;
              ...
              {posStats.map((stat) => (
                <div key={stat.name} className="space-y-2">
                  ...
                  <div className="h-4 bg-gray-100 rounded-full overflow-hidden border border-gray-100 relative">
                    <div 
                      className={`h-full transition-all duration-1000 ease-in-out ${stat.percentage === 100 ? 'bg-green-500' : 'bg-blue-500'}`}
